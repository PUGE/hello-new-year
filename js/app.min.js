...
function initwishchoice() {
  for (var e = wishchoice.getElementsByTagName("div"), t = 0; t < e.length; t++) {
    var r = e[t];
    TweenLite.to(r, 0, {
      autoAlpha: 0,
      scaleX: .5,
    ...
    r.addEventListener("click", actionChoice),
    r.addEventListener("click", actionChoice)
  }
}
function actionChoice() {
  var e = this.className,
  t = this.getElementsByTagName("span"),
  r = "default" == e ? document.getElementById("mywish").value: t[0].innerHTML;
  "default" === e && "" == r || displayWishChoice(this.className, r)
}
...
function aud_play_pause() {
  ...
  e.paused ? (e.play(), soundbtn.className = "on") : (e.pause(), soundbtn.className = "off")
}
...
btnFBfoot = document.getElementById("btnFBfoot"),
btnTWfoot = document.getElementById("btnTWfoot"),
openIdWish;
...
btnFBfoot.addEventListener("click",
function(e) {
  e.preventDefault();
  var t = "http://www.clair-et-net.com/hello2015/",
  r = "Say hello to 2015";
  return window.open("http://www.facebook.com/sharer.php?u=" + encodeURIComponent(t) + "&t=" + encodeURIComponent(r), "sharer", "toolbar=0,status=0,width=626,height=436"),
  !1
}),
btnTWfoot.addEventListener("click",
function(e) {
  e.preventDefault();
  var t = "http://www.clair-et-net.com/hello2015/",
  r = "Say hello to 2015";
...
function(e) {
  e.preventDefault(),
  initwishchoice(),
  wishchoice.style.display = "block",
  TweenLite.to(wishchoice, 2, {
    autoAlpha: 1,
    ease: Back.easeOut,
    delay: .5
  })
...
document.getElementById("btnmywish").addEventListener("click",
function() {
  var e = document.getElementById("mywish").value;
  "" !== e && displayWishChoice("default", e)
});
...
var soundbtn = document.getElementById("soundcontrol");
